This is simply a git mirror to allow benchmarks using ann-benchmark. The original implementation can be found at http://www.uef.fi/web/machine-learning/software.
